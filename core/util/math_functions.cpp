...
namespace dlex_cnn
{
	...
	template void gemm<double>(bool bTransA, bool bTransB, const int M, const int N, const int K, const float alpha, const double* A, const double* B, const float beta, double* C);
